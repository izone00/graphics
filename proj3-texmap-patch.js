...
class Patch {
  constructor(gl, N, image, src_vert, src_frag, light, material) {
    ...
    gl.uniform3fv(
      this.shader.loc_uniforms["material.ambient"],
      material.ambient
    );
    gl.uniform3fv(
      this.shader.loc_uniforms["material.diffusive"],
      material.diffusive
    );
    gl.uniform3fv(
      this.shader.loc_uniforms["material.specular"],
      material.specular
    );
    gl.uniform1f(
      this.shader.loc_uniforms["material.shininess"],
      material.shininess
    );
    gl.useProgram(null);
  }
